...
package com.weblab.adt.weblab.ui.widget;
...
//import com.weblab.adt.weblab.ui.fragment.ContactFragment;
...
public class TopTabButton extends FrameLayout {
    ...
    private void initView() {
        ...
        tabDepartmentBtn.setOnClickListener(new OnClickListener() {
            @Override
...
//                handler.sendMessage(message);
        ...
        tabALLBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
//                Handler handler = ContactFragment.getHandler();
//                Message message = handler.obtainMessage();
