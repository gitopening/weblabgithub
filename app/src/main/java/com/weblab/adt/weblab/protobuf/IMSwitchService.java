...
public final class IMSwitchService {
  ...
  public static final class IMP2PCmdMsg extends
    ...
    public static IMSwitchService.IMP2PCmdMsg parseFrom(
    ...
    public static IMSwitchService.IMP2PCmdMsg parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static IMSwitchService.IMP2PCmdMsg parseFrom(
    ...
    public static IMSwitchService.IMP2PCmdMsg parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static IMSwitchService.IMP2PCmdMsg parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static IMSwitchService.IMP2PCmdMsg parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(IMSwitchService.IMP2PCmdMsg prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          IMSwitchService.IMP2PCmdMsg, Builder>
        implements
        // @@protoc_insertion_point(builder_implements:IM.SwitchService.IMP2PCmdMsg)
        IMSwitchService.IMP2PCmdMsgOrBuilder {
      // Construct using IMSwitchService.IMP2PCmdMsg.newBuilder()
      private Builder() {
      ...
      public IMSwitchService.IMP2PCmdMsg getDefaultInstanceForType() {
        return IMSwitchService.IMP2PCmdMsg.getDefaultInstance();
      }

      public IMSwitchService.IMP2PCmdMsg build() {
        IMSwitchService.IMP2PCmdMsg result = buildPartial();
      ...
      public IMSwitchService.IMP2PCmdMsg buildPartial() {
        IMSwitchService.IMP2PCmdMsg result = new IMSwitchService.IMP2PCmdMsg(this);
      ...
      public Builder mergeFrom(IMSwitchService.IMP2PCmdMsg other) {
        if (other == IMSwitchService.IMP2PCmdMsg.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        IMSwitchService.IMP2PCmdMsg parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (IMSwitchService.IMP2PCmdMsg) e.getUnfinishedMessage();
          throw e;
        } finally {
