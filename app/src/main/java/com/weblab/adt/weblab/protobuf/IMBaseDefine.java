...
public final class IMBaseDefine {
  ...
  public static final class ContactSessionInfo extends
    ...
    private IMBaseDefine.SessionStatusType sessionStatus_;
    /**
     * <code>required .IM.BaseDefine.SessionStatusType session_status = 3;</code>
     */
    ...
    private IMBaseDefine.MsgType latestMsgType_;
    /**
     * <code>required .IM.BaseDefine.MsgType latest_msg_type = 7;</code>
     */
    ...
    private void initFields() {
      ...
      sessionStatus_ = IMBaseDefine.SessionStatusType.SESSION_STATUS_OK;
      updatedTime_ = 0;
      latestMsgId_ = 0;
      latestMsgData_ = com.google.protobuf.ByteString.EMPTY;
      latestMsgType_ = IMBaseDefine.MsgType.MSG_TYPE_SINGLE_TEXT;
    ...
    public static final class Builder extends
      ...
      private IMBaseDefine.SessionStatusType sessionStatus_ = IMBaseDefine.SessionStatusType.SESSION_STATUS_OK;
      /**
       * <code>required .IM.BaseDefine.SessionStatusType session_status = 3;</code>
       */
      public boolean hasSessionStatus() {
  ...
  bitField0_ |= 0x00000020;
      ...
      private IMBaseDefine.MsgType latestMsgType_ = IMBaseDefine.MsgType.MSG_TYPE_SINGLE_TEXT;
      /**
       * <code>required .IM.BaseDefine.MsgType latest_msg_type = 7;</code>
       */
      public boolean hasLatestMsgType() {
  ...
  public static final class UserStat extends
    ...
    private IMBaseDefine.UserStatType status_;
    /**
     * <code>required .IM.BaseDefine.UserStatType status = 2;</code>
     */
    public boolean hasStatus() {
    ...
    private void initFields() {
      userId_ = 0;
      status_ = IMBaseDefine.UserStatType.USER_STATUS_ONLINE;
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
      byte isInitialized = memoizedIsInitialized;
    ...
    public static final class Builder extends
      ...
      private IMBaseDefine.UserStatType status_ = IMBaseDefine.UserStatType.USER_STATUS_ONLINE;
      /**
       * <code>required .IM.BaseDefine.UserStatType status = 2;</code>
       */
      public boolean hasStatus() {
  ...
  public static final class GroupInfo extends
    ...
    private void initFields() {
      ...
      groupAvatar_ = "";
      groupCreatorId_ = 0;
      groupType_ = IMBaseDefine.GroupType.GROUP_TYPE_NORMAL;
      shieldStatus_ = 0;
  ...
  public static final class UserTokenInfo extends
    ...
    private IMBaseDefine.ClientType userType_;
    /**
     * <code>required .IM.BaseDefine.ClientType user_type = 2;</code>
     */
    ...
    private void initFields() {
      userId_ = 0;
      userType_ = IMBaseDefine.ClientType.CLIENT_TYPE_WINDOWS;
      token_ = "";
      pushCount_ = 0;
      pushType_ = 0;
    }
    ...
    public static final class Builder extends
      ...
      private IMBaseDefine.ClientType userType_ = IMBaseDefine.ClientType.CLIENT_TYPE_WINDOWS;
      /**
       * <code>required .IM.BaseDefine.ClientType user_type = 2;</code>
       */
      public boolean hasUserType() {
  ...
  public static final class AuthInfo extends
     ...
     * <code>required string allowd_user_ids = 3;</code>
     */
    public String getAllowdUserIds() {
      Object ref = allowdUserIds_;
      if (ref instanceof String) {
        return (String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    private Object allowdGroupIds_;
    /**
     * <code>required string allowd_group_ids = 4;</code>
     */
     ...
     * <code>required string allowd_group_ids = 4;</code>
     */
    public String getAllowdGroupIds() {
      Object ref = allowdGroupIds_;
      if (ref instanceof String) {
        return (String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    private Object authInterfaces_;
    /**
     * <code>required string auth_interfaces = 5;</code>
     */
     ...
     * <code>required string auth_interfaces = 5;</code>
     */
    public String getAuthInterfaces() {
      Object ref = authInterfaces_;
      if (ref instanceof String) {
        return (String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    public static IMBaseDefine.AuthInfo parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static IMBaseDefine.AuthInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static IMBaseDefine.AuthInfo parseFrom(
    ...
    public static IMBaseDefine.AuthInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static IMBaseDefine.AuthInfo parseFrom(
    ...
    public static IMBaseDefine.AuthInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static IMBaseDefine.AuthInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(IMBaseDefine.AuthInfo prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          IMBaseDefine.AuthInfo, Builder>
        implements
        // @@protoc_insertion_point(builder_implements:IM.BaseDefine.AuthInfo)
        IMBaseDefine.AuthInfoOrBuilder {
      // Construct using IMBaseDefine.AuthInfo.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public IMBaseDefine.AuthInfo getDefaultInstanceForType() {
        return IMBaseDefine.AuthInfo.getDefaultInstance();
      }

      public IMBaseDefine.AuthInfo build() {
        IMBaseDefine.AuthInfo result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public IMBaseDefine.AuthInfo buildPartial() {
        IMBaseDefine.AuthInfo result = new IMBaseDefine.AuthInfo(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(IMBaseDefine.AuthInfo other) {
        if (other == IMBaseDefine.AuthInfo.getDefaultInstance()) return this;
        if (other.hasAppKey()) {
          bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        IMBaseDefine.AuthInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (IMBaseDefine.AuthInfo) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  public static final class DepartInfo extends
    ...
    private IMBaseDefine.DepartmentStatusType deptStatus_;
    /**
     * <code>required .IM.BaseDefine.DepartmentStatusType dept_status = 5;</code>
     */
    ...
    private void initFields() {
      ...
      deptName_ = "";
      parentDeptId_ = 0;
      deptStatus_ = IMBaseDefine.DepartmentStatusType.DEPT_STATUS_OK;
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
      byte isInitialized = memoizedIsInitialized;
  ...
  bitField0_ |= 0x00000004;
      ...
      private IMBaseDefine.DepartmentStatusType deptStatus_ = IMBaseDefine.DepartmentStatusType.DEPT_STATUS_OK;
      /**
       * <code>required .IM.BaseDefine.DepartmentStatusType dept_status = 5;</code>
       */
      public boolean hasDeptStatus() {
