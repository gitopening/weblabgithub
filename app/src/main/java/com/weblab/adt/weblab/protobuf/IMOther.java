...
public final class IMOther {
  ...
  public static final class IMHeartBeat extends
    ...
    public static IMOther.IMHeartBeat parseFrom(
    ...
    public static IMOther.IMHeartBeat parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static IMOther.IMHeartBeat parseFrom(
    ...
    public static IMOther.IMHeartBeat parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static IMOther.IMHeartBeat parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static IMOther.IMHeartBeat parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(IMOther.IMHeartBeat prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          IMOther.IMHeartBeat, Builder>
        implements
        // @@protoc_insertion_point(builder_implements:IM.Other.IMHeartBeat)
        IMOther.IMHeartBeatOrBuilder {
      // Construct using IMOther.IMHeartBeat.newBuilder()
      private Builder() {
      ...
      public IMOther.IMHeartBeat getDefaultInstanceForType() {
        return IMOther.IMHeartBeat.getDefaultInstance();
      }

      public IMOther.IMHeartBeat build() {
        IMOther.IMHeartBeat result = buildPartial();
      ...
      public IMOther.IMHeartBeat buildPartial() {
        IMOther.IMHeartBeat result = new IMOther.IMHeartBeat(this);
        return result;
      }

      public Builder mergeFrom(IMOther.IMHeartBeat other) {
        if (other == IMOther.IMHeartBeat.getDefaultInstance()) return this;
        setUnknownFields(
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        IMOther.IMHeartBeat parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (IMOther.IMHeartBeat) e.getUnfinishedMessage();
          throw e;
        } finally {
